                            ...
                            <table class="w-full divide-y divide-gray-200">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            class="w-48 px-6 py-4 whitespace-nowrap text-sm text-center text-gray-500 flex justify-between">
                                            ...
                                            <form action="{{route('admin.products.destroy', $product)}}" class="destroyButton"
                                                ...
                                                @method("DELETE")
                                                <button
                                                    class="text-red-500 hover:text-red-200 font-bold hover:underline transition-all ease-in-out duration-200">REMOVER</button>
                                            </form>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
                                        <td colspan="5"
                                            ...
                                            <h3>Nenhum produto encontrado em sua loja</h3>
                                        </td>
                                    </tr>
                                    @endforelse
                                </tbody>
